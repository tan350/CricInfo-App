...
namespace Vispl.Trainee.CricInfo.BM
{
    public class MatchValidationBL : IMatchValidationBL
    {
        ...
        public List<Dictionary<string, object>> GetBattingData(int teamId, int matchId)
        {
            try
            {
                MatchSqlDLObject = new MatchSqlDL();
                return MatchSqlDLObject.GetBattingDataForTeamAndMatch(teamId, matchId);
            }
            finally
            {
                MatchSqlDLObject = null;
        ...
        public List<Dictionary<string, object>> GetFallOfWicketData(int teamId, int matchId)
        {
            try
            {
                MatchSqlDLObject = new MatchSqlDL();
                return MatchSqlDLObject.GetFallOfWicket(teamId, matchId);
            }
            finally
            {
                MatchSqlDLObject = null;
